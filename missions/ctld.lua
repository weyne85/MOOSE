---@diagnostic disable: undefined-global, undefined-global, need-check-nil, assign-type-mismatch, deprecated, undefined-field
--[[
...
ctld.maximumSearchDistance = 40000 -- max distance for troops to search for enemy
ctld.maximumMoveDistance = 20000 -- max distance for troops to move from drop point if no enemy is nearby
ctld.minimumDeployDistance = 10000 -- minimum distance from a friendly pickup zone where you can deploy a crate
